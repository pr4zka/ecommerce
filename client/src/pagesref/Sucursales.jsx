...
import AddTaskSucursales from '../components/AddTaskSucursales';
...
const Sucursales = () => {
  ...
  return (
    <>
        <div className='mt-12'>
                <h1 className='text-center text-2xl uppercase'>Mantener s
                ucursales</h1>
                <div className='flex justify-center ml-7 pt-5'>
                    <div className='flex flex-row'>
                        <p className='text-xl hover:font-semibold mt-0.5'>Agregar</p>
                        <AddTaskSucursales handleTaskAddition={handleTaskAddition} />
                    </div>
                    <div className=''>
