    ...
    <>
      <nav className="bg-slate-100 flex  w-full border-solid border-b-[2px] border-sky-100">
        <ul className="flex p-3 text-slate-900 ml-10">
          <li
            className="pr-3 p-1 hover:text-slate-600
            hover:font-semibold
          ...
          <li
            className="ml-14 pl-3 pr-3 p-1 hover:text-slate-600
          ...
          {show === true ? (
            <div
              className="list bg-slate-100 absolute top-16 left-10 	w-36 flex flex-col-reverse rounded-xl
